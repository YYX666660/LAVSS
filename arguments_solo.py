...
class ArgParser(object):
    def __init__(self):
        ...
        parser.add_argument('--id', default='64_roipool_whole_add_coslr',                         # 改
        ...
        parser.add_argument('--weights_visual', type=str, default='ckpt_2.5Dsep_musicpre/-2mix-LogFreq-resnet18dilated-unet7-linear-frames3stride20-maxpool-ratio-weightedLoss-channels32-epoch60-step40_50/frame_best.pth', help="weights for visual stream")
        ...
        parser.add_argument('--unet_input_nc', type=int, default=1, help="input spectrogram number of channels")
        parser.add_argument('--unet_output_nc', type=int, default=1, help="output spectrogram number of channels")
        parser.add_argument('--weights_unet', type=str, default='ckpt_2.5Dsep_musicpre/-2mix-LogFreq-resnet18dilated-unet7-linear-frames3stride20-maxpool-ratio-weightedLoss-channels32-epoch60-step40_50/sound_best.pth', help="weights for unet")
        ...
        parser.add_argument('--seed', default=1234, type=int,
                            help='manual seed')
        parser.add_argument('--ckpt', default='./ckpt_2.5Dsep_pos',
    ...
    def add_train_arguments(self):
        ...
        parser.add_argument('--lr_classifier', type=float, default=5e-4, help='learning rate for audio classifier')
...
#         parser = argparse.ArgumentParser()
#         # Model related arguments
#         parser.add_argument('--id', default='64_roipool_whole_choose-2mix-LogFreq-resnet18dilated-unet7-linear-frames3stride20-maxpool-ratio-weightedLoss-channels32-epoch60-step10_20_30',                         # 改
#                             help="a name for identifying the model")
#         parser.add_argument('--num_mix', default=2, type=int,
#                             help="number of sounds to mix")
#         parser.add_argument('--arch_sound', default='unet7',
