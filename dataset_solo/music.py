...
class MUSICMixDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            mag_mix, mags, phase_mix = self._mix_n_and_stft(audios_l)
            mag_mix_r, mags_r, phase_mix_r = self._mix_n_and_stft(audios_r)
        ...
        # ret_dict = {'mag_mix': mag_mix, 'frames': frames, 'mags': mags, 'mag_mix_r': mag_mix_r, 'mags_r': mags_r}
        ret_dict = {'mag_mix': mag_mix, 'frames': frames, 'mags': mags, 'mag_mix_r': mag_mix_r, 'mags_r': mags_r, 'position': position}
        if self.split != 'train':
