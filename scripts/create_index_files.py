...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_audio', default='MUSIC_tian/audio',
                        help="root for extracted audio files")
    parser.add_argument('--root_frame', default='MUSIC_tian/frames',
                        help="root for extracted video frames")
    parser.add_argument('--fps', default=1, type=int,
                        help="fps of video frames")
    parser.add_argument('--path_output', default='MUSIC_tian/MUSIC_data',
    ...
    for name, subset in zip(['train_new', 'val_new'], [trainset, valset]):
