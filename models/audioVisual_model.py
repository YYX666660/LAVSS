...
class AudioVisualModel(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        spectrogram2classify = torch.log(separated_spectrogram + 1e-10) #get log spectrogram    预测的输出频谱
        ...
        label_prediction = self.net_classifier(spectrogram2classify)        # 将预测的输出频谱也经过resnet18得到用于classify的输出特征
