...
class AudioVisual7layerUNet(nn.Module):
    ...
    #     audio_conv5feature = audio_conv5feature + self.attention1(audio_conv5feature, visual_feat_ori)
    #     audio_conv6feature = self.audionet_convlayer6(audio_conv5feature)
    #     audio_conv6feature = audio_conv6feature + self.attention2(audio_conv6feature, visual_feat_ori)
    #     audio_conv7feature = self.audionet_convlayer7(audio_conv6feature)       # [512,2,2]
    #     audio_conv7feature = audio_conv7feature + self.attention3(audio_conv7feature, visual_feat_ori)
